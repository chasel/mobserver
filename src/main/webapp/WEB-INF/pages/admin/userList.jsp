...
<div class="span10">
    ...
    <div id="advance.search" align="right">
    	<a href="#advance-search-modal" class="text-info" data-toggle="modal"><fmt:message key="userList.advance.search"/></a>
    </div>
    </form>
	...
	<div id="advance-search-modal" class="modal hide fade" tabindex="-1" data-width="760">
  		<div class="modal-header">
    		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    		<h3 align="center"><fmt:message key="advance.search.title"/></h3>
  		</div>
  		<div class="modal-body">
	    	<div class="form-horizontal">
	    		<div class="control-group">
	    			<label class="control-label" for="inputEmail"><fmt:message key="advance.search.email"/>:</label>
	    			<div class="controls">
		    			<input type="text" id="inputEmail">
	    			</div>
	    		</div>
	    		<div class="control-group">
	    			<label class="control-label" for="deviceType"><fmt:message key="advance.checkbox.devicetype"/>:</label>
	    			<div class="controls">
  		...
  		<div class="modal-footer">
	    	<button type="button" data-dismiss="modal" class="btn"><fmt:message key="advance.button.cancel"/></button>
	    	<button type="button" class="btn btn-primary"><fmt:message key="advance.button.submit"/></button>
  		</div>
	</div>
</div>
